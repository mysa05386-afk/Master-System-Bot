...
client.on('interactionCreate', async (interaction) => {
    ...
    if (interaction.isStringSelectMenu() && interaction.customId === 'admin_action') {
        ...
        // ملاحظة: للتنفيذ الفعلي، نحتاج لذكر العضو. سأقوم بتوضيح كيفية إتمام الأمر.
        await interaction.update({ content: `⚠️ تم اختيار ${action}. (يرجى منشن العضو لتنفيذ العقوبة في الإصدار القادم أو استخدام الأوامر المباشرة)`, components: [] });
    }
});
